...
public class ItemViewer extends AbstractDSpaceTransformer implements CacheableProcessingComponent
{
    ...
    public SourceValidity getValidity()
    {
		...
		// @kepler: add log message that we are viewing the item
	...
	*/
	ReferenceSet referenceSet = division.addReferenceSet("collection-viewer", ReferenceSet.TYPE_DETAIL_VIEW);
